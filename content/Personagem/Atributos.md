...
## Ego
Representa confiança, orgulho, charme e como você interpreta sua técnica inata. Usado como atributo de conjuração para técnicas amaldiçoadas.

Para determinar os atributos iniciais de seu personagem, role **6x 3d6**. Use as 5 melhores combinações e distribua os valores como quiser em seus 5 atributos. Caso você não tenha nenhum valor com +2 ou mais, escolha 1 atributo para ficar como +2.
