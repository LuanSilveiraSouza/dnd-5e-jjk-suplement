O mundo de Jujutsu é composto por uma miríada de Técnicas Inatas, mas os jogadores não estão presos às Técnicas inspiradas nos personagens da obra. A ideia é explorar ao máximo a criatividade dos jogadores e tornar os aspectos de roleplay e de combate mais próximos um do outro. 

A Técnica Inata é uma simplificação da personalidade, objetivos e forma de abordar situações de um personagem em específico. A interpretação da Técnica também impacta, fazendo até mesmo dois usuários da mesma Técnica terem variações que exprimem suas essências.

O principal ponto para evoluir sua Técnica Inata é a visualização: Você pode fazer qualquer coisa, desde que acredite que seja possível. O primeiro passo para a criação de sua expressão é utilizar uma Técnica já existente como base. Você pode alterar o tipo de dano ou algum efeito secundário, por exemplo.
...
Uma técnica que é ofensiva, defensiva, provê movimentação e suporte não é uma técnica realista: você deve abrir mão de X para obter eficiência em Y. Considere também que as Técnicas Inatas possuem uma progressão relativamente semelhante e molde a sua em volta disso.
# Progressão

## Atributo de Conjuração
Primeiro, determine o atributo de conjuração de sua Técnica. Toda técnica permite usar Carisma (já que a Técnica deriva da interpretação da alma do personagem) e Sabedoria OU Inteligência, o que fazer mais sentido. Técnicas com nuances e regras específicas e técnicas que envolvem leis da física ou da natureza tendem a usarem Inteligência, já técnicas envolvendo emoções, técnicas que "brutas" ou "simples" na usabilidade e técnicas que mexem com a mente ou a alma tendem a usar Sabedoria. 
