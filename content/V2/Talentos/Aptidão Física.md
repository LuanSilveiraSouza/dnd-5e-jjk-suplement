...
- Quando você acerta uma criatura com um ataque desarmado ou uma arma improvisada em seu turno, você pode usar uma ação grátis para tentar agarrar o alvo.
## Nível 3 - Resistente
...
## Nível 5 - Investida
Quando você usa a ação bônus de Disparar seguido de um ataque corpo a corpo e se mover pelo menos 2 unidades em linha reta imediatamente antes de atacar, você ganha um bônus de +5 na jogada de dano do ataque (se você escolheu fazer um ataque corpo a corpo e acertou) ou realiza a ação de Empurrar, com o alvo se deslocando até 2 unidades para longe de você em caso de sucesso.
## Nível 7 - Atacante Selvagem
...
## Nível 1 - Proficiência em Armas de Uma Mão
- Você ganha proficiência com Armas de de Uma Mão. Ao fazer rolagens de acerto, dobre seu modificador de Corpo ou Agilidade (caso o modificador seja negativo, considere-o como 0). 
## Nível 5 - Duelista
...
## Nível 7 - Especialista em Arma Amaldiçoada
...
- Você ganha proficiência com Armas de de Duas Mãos. Ao fazer rolagens de acerto, dobre seu modificador de Corpo ou Agilidade (caso o modificador seja negativo, considere-o como 0.
## Nível 5 - Esmagador
Você é experiente na arte de esmagar seus inimigos, o que lhe concede os seguintes benefícios:
- Uma vez por turno, quando você acerta uma criatura com um ataque que causa dano contundente, você pode movê-la 1 unidade para um espaço desocupado, desde que o alvo não seja mais do que um tamanho maior que você.
...
- Antes de realizar um ataque corpo a corpo com uma arma de duas mãos, você pode optar por sofrer uma penalidade de -1d4 na jogada de ataque. Se o ataque acertar, você adiciona +1d8 ao dano do ataque.
## Nível 5 - Mestre em Armas de Haste
- Quando você usa a ação Atacar e ataca apenas com uma arma com a propriedade **Extensão**, você pode usar uma ação bônus para fazer um ataque corpo a corpo com a extremidade oposta da arma. Este ataque usa o mesmo modificador de habilidade do ataque principal. O dado de dano da arma para este ataque é um 1d4 e causa dano contundente.
- Enquanto você estiver empunhando uma arma com a propriedade **Extensão**, outras criaturas provocam um ataque de oportunidade seu quando entrarem no seu alcance com essa arma.
## Nível 7 - Especialista em Arma Amaldiçoada
Você praticou extensivamente o uso de uma arma amaldiçoada de sua escolha, obtendo sua masterização. Caso a arma não possua técnica imbuída nela, você mantém sua perícia superior em replicatas dela. Ao usar a arma você recebe os seguintes benefícios:
- Adicione seu modificador de Ego em todas as rolagens de dano com a arma escolhida.
# Mestre em Armas de Fogo
## Nível 1 - Atirador
- Você ganha proficiência com Armas de Fogo. Ao fazer rolagens de acerto, dobre seu modificador de Corpo ou Agilidade (caso o modificador seja negativo, considere-o como 0.
- Você pode recarregar armas de fogo usando uma ação bônus.
...
- Seus ataques com armas de fogo ignoram 1/2 e 3/4 de cobertura.
## Nível 5 - Pistoleiro
...
Você praticou extensivamente o uso de uma arma amaldiçoada de sua escolha, obtendo sua masterização. Caso a arma não possua técnica imbuída nela, você mantém sua perícia superior em replicatas dela. Ao usar a arma você recebe os seguintes benefícios:
- Adicione seu modificador de Ego em todas as rolagens de dano com a arma escolhida.
## Nível 9 - Mira Telescópica
- O alcance de todas as armas de fogo é dobrado.
- Você pode recarregar armas de fogo usando uma ação grátis.
# Mestre em Arcos
## Nível 1 - Arqueiro
- Você ganha proficiência com Arcos. Ao fazer rolagens de acerto, dobre seu modificador de Corpo ou Agilidade (caso o modificador seja negativo, considere-o como 0.
- Estar a 1 unidade de uma criatura hostil não impõe desvantagem em suas jogadas de ataque à distância com arcos.
## Nível 3 - Tiro Preciso
- Você ganha +1 em rolagens de acerto em ataques de arco.
- Você pode usar sua Ação Bônus para mirar nos pontos fracos do oponente. Ao fazer isso, aumente o alcance de crítico do próximo disparo de arco feito neste turno em 1d4.
## Nível 5 - Tiro Rápido
...
- Você não recebe desvantagem em testes de Percepção envolvendo visão.
...
- Seu deslocamento aumenta em 1 unidade.
...
- Você recebe um bônus de +3 na iniciativa.
- Outras criaturas não têm vantagem em jogadas de ataque contra você por não serem vistas por você.
## Nível 5 - Atleta
- Você gasta apenas 1 unidade de deslocamento para se levantar da posição de caído;
- Escalar, Nadar, Andar Agachado, Salto Longo e Salto Alto não necessitam de testes, e você gastar seus pontos de deslocamento normalmete.
